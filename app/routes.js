...
import F4SingleSelectFormCTR from './containers/F4SingleSelectFormCTR/F4SingleSelectFormCTR';
  ...
  <Route path={path} component={App}>
    ...
    */}
    ...
    {/* plop will append routes here */}
		<Route path={path + "/singleselectform"} component={ F4SingleSelectFormCTR } />
